<div align="center">
  ...
  <h1>
    ...
    <strong>I'm Goteh Mbaza Patrick</strong>
  </h1>
  <p>
    🚀 DevOps & AI Engineer | ☁️ Cloud Specialist | ⚙️ Automation Enthusiast
  </p>
  <p>
     <em>
...
<h3>🌟 Who I am</h3>
<p>
  <strong>DevOps Engineer & AI Infrastructure Specialist</strong> focused on building 
  <strong>scalable, secure, and automated cloud-native systems</strong>.
</p>

<p>
  I design and deploy <strong>production-grade infrastructure</strong>, implement 
  <strong>CI/CD pipelines</strong>, and manage <strong>containerized & AI workloads</strong> 
  across <strong>AWS</strong> and <strong>Azure</strong>.
</p>

<h3>📚 Currently Working On</h3>
<ul>
  <li><strong>Kubernetes-based AI deployments</strong> (LLMs & APIs)</li>
  <li><strong>End-to-end CI/CD pipelines</strong> for microservices</li>
  <li><strong>Infrastructure as Code</strong> with Terraform & CloudFormation</li>
  <li><strong>MLOps & AI automation systems</strong></li>
</ul>

<h3>🚀 What Drives Me</h3>
<ul>
  <li>Designing <strong>resilient cloud infrastructure</strong></li>
  <li>Automating deployments & workflows</li>
  <li>Building <strong>AI-powered systems</strong></li>
  <li>Improving system performance & reliability</li>
</ul>

<h3>🎯 Vision</h3>
<p>
  To become a leading <strong>DevOps & AI Engineer</strong>, building 
  <strong>intelligent, scalable infrastructure</strong> that powers next-generation applications.
</p>
